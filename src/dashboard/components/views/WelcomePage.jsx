...
import { SwimmingFish, Bubbles } from '../common/AquaticElements';
...
const WelcomePage = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-[calc(100vh-114px)] py-12 px-4 relative overflow-hidden ${theme === 'aquatic' ? 'bg-gradient-to-b from-background to-primary/5' : 'bg-gradient-to-b from-background to-neon-primary/20'}`}>
      <ParticleEffect />
      <AnimatedShips />
      <WaveAnimation />
      {theme === 'aquatic' && (
      ...
      <div className="text-center max-w-xl mx-auto z-10 backdrop-blur-sm bg-card/80 p-8 rounded-xl shadow-lg animate-float border border-primary/20">
        <div className="mb-8">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 24 24" 
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Analyze and visualize the quality of your Python code documentation with NAVSEA's advanced evaluation tool
          </p>
        </div>
        ...
        {error && error !== "No metrics data available. Please analyze a file or directory first." && (
          <div className="mt-6 p-3 bg-destructive/10 border border-destructive/30 text-destructive rounded-md">
            {error}
          </div>
        )}
