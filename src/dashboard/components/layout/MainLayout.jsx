...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-background text-foreground transition-theme overflow-hidden ${theme === 'neon' ? 'neon-theme-wrapper' : 'aquatic-theme-wrapper'}`}>
      {/* Background elements */}
      {theme === 'neon' && (
      ...
      <footer className={`${theme === 'neon' ? 'bg-neon-surface/50 shadow-[0_-5px_15px_rgba(0,0,0,0.1)]' : 'bg-card shadow-sm'} py-3 mt-8 relative z-10`}>
