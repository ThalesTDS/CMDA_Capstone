...
import { formatMetricValue, findBestAndWorstMetrics } from '../../utils/utils';
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 mr-1 ${theme === 'neon' ? 'text-accent' : 'text-primary'}`} viewBox="0 0 20 20" fill="currentColor">
