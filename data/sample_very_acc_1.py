...
def bubble_sort_iterative(collection: list[Any]) -> list[Any]:
    """
        Sorts a list in ascending order via iteration. It starts with moving
        from the end of the list to the front, and with each step i, we loop again
        up to i and swap elements when x_j > x_j-1. We keep track if we swapped within
        the second loop until swapped is false after the loop ends.
    """
